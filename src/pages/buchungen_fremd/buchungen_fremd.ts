...
@Component({
    templateUrl: 'buchungen_fremd.html',
    selector: 'page-buchungen_fremd',
})
export class Buchungen_fremdPage {
  ...
  ionViewWillEnter() {
    ...
    xhr.onreadystatechange = () => {
      ...
      if (this.globVars.testFlag==0) {
        xhr.open("GET", "https://ordination-kutschera.at/zen/php/getstamps.php?userid=" + this.globVars.globAlienUserID + "&amount=" + this.buchungenAmount, true);
      }
      else {
            xhr.open("GET", "/server/zen/php/getstamps.php?userid=" + this.globVars.globAlienUserID + "&amount=" + this.buchungenAmount, true);
      }
